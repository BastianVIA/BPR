...
public class GetStartUpResponse
{
    ...
    public static GetStartUpResponse From(GetActuatorStartUpAmountsDto actuatorResult,
        GetTestStartUpAmountsDto testResult)
    {
        return new GetStartUpResponse(actuatorResult.ActuatorAmount, testResult.TestResultAmount,
            testResult.TestErrorAmount,
