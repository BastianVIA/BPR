...
public class GetActuatorsWithFilterQuery : IQuery<GetActuatorsWithFilterDto>
{
    ...
    public static GetActuatorsWithFilterQuery Create(string? pcbaUid, string? itemNo, int? manufacturerNo,
        int? productionDateCode)
    {
        if (productionDateCode == null && manufacturerNo == null && productionDateCode == null && pcbaUid == null &&
            itemNo == null)
        {
