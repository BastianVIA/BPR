...
namespace Frontend.Service
{
    ...
    public enum CsvProperties
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"WorkOrderNumber")]
        WorkOrderNumber = 0,

        [System.Runtime.Serialization.EnumMember(Value = @"SerialNumber")]
        SerialNumber = 1,

        [System.Runtime.Serialization.EnumMember(Value = @"CommunicationProtocol")]
        CommunicationProtocol = 2,

        [System.Runtime.Serialization.EnumMember(Value = @"ArticleNumber")]
        ArticleNumber = 3,

        [System.Runtime.Serialization.EnumMember(Value = @"ArticleName")]
        ArticleName = 4,

        [System.Runtime.Serialization.EnumMember(Value = @"CreatedTime")]
        CreatedTime = 5,

        [System.Runtime.Serialization.EnumMember(Value = @"PCBAUid")]
        PCBAUid = 6,

        [System.Runtime.Serialization.EnumMember(Value = @"PCBAManufacturerNumber")]
        PCBAManufacturerNumber = 7,

        [System.Runtime.Serialization.EnumMember(Value = @"PCBAItemNumber")]
        PCBAItemNumber = 8,

        [System.Runtime.Serialization.EnumMember(Value = @"PCBASoftware")]
        PCBASoftware = 9,

        [System.Runtime.Serialization.EnumMember(Value = @"PCBAProductionDateCode")]
        PCBAProductionDateCode = 10,

        [System.Runtime.Serialization.EnumMember(Value = @"PCBAConfigNo")]
        PCBAConfigNo = 11,
